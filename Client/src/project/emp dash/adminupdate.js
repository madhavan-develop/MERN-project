  ...
  function Adminupdate(event){
    ...
    return(
     ...
     <div class="text-center d-flex flex-column align-items-center register">
        ...
        <h1 class="mt-5 text-light ">EMPLOYEE UPDATE</h1>
        <table className=' p-2' cellpadding="10px">
            ...
            <tr>
                <td> <label>City</label></td>
                    <td> <input type="text" id="city"value={city}  onChange={(updat)=>setCity(updat.target.value)}/></td>
            </tr>
            <tr>
                <td> <label>STATE</label></td>
                    <td> <input type="text" id="state"value={state} onChange={(updat)=>setState(updat.target.value)}/></td>
            </tr>
            <tr>
